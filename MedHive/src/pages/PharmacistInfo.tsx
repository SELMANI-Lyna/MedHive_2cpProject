...
const PharmacistInfo: React.FC<{ userData: any; pharmacyData: any }> = ({
  userData,
  pharmacyData,
}) => {
  const inputClass =
  ...
  // Adjust height when component mounts or when userData changes
  useEffect(() => {
    adjustTextareaHeight();
  }, [userData?.tempsDeTravail]);
  ...
  return (
    <div className="w-[66vw] relative right-[1vw] font-inter">
      ...
      <div className="grid grid-cols-2 gap-x-10 gap-y-6">
        ...
        <div className="col-span-2">
          <label className={labelClass}>Days and Opening Hours</label>
          <textarea
            ref={textareaRef}
            value={
              userData?.tempsDeTravail
                ? userData.tempsDeTravail.split(",").join("\n")
                : "08:00 - 19:00"
            }
      ...
      {/* License */}
      <h3 className="mt-6 text-l text-[#718096] dark:text-gray-400 text-left">
        My license:
      </h3>
      <div className="mt-3 flex justify-center items-center">
        <img
          src={userData?.licence || "/Images/ExempleLicencePharm.jpg"}
          alt="License"
